...
Usage: bun packages/agent-registry/bin/agent-registry-cli.js <command> [flags]
...
Examples:
  ...
  bun packages/agent-registry/bin/agent-registry-cli.js heartbeat --agent-id kimi-code-primary-001 --status busy
  bun packages/agent-registry/bin/agent-registry-cli.js publish --agent-id kimi-code-primary-001 --epic https://linear.app/... --task JUM-615 --kind progress --summary "fallback wired"
  bun packages/agent-registry/bin/agent-registry-cli.js watch --epic https://linear.app/...
  bun packages/agent-registry/bin/agent-registry-cli.js status --epic https://linear.app/...
`);
}
