...
- Soft-delete tombstones (`deletedAt`) are the only delete path for User/Organization; uniqueness is released on tombstone; physical purge is out of scope (JUM-791).
