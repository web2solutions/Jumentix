...
13. Commits, pushes, and merges targeting `dev` must run only the canonical unit-test gate.
...
6. Commit, push, and merge hooks select the required unit or full-matrix gate by destination.
