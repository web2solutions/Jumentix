...
| Ponte de CI hospedado | Requisitos `014`, `107` | Requisito `113`, `.circleci/config.yml`, `.github/workflows/ci.yml` | CircleCI e canonico; GitHub Actions esta retido, desabilitado por padrao atras da variavel de Actions do repositorio `JUMENTIX_ENABLE_GITHUB_ACTIONS_CI`; gates de cobertura do repositorio permanecem autoritativos. |
