...
1. Requirement files in `.agents/requirements/project/` and `.agents/requirements/software/`: `128`
2. Unique requirement IDs: `128`
3. IDs covered in `SPEC-REQUIREMENTS-TRACEABILITY-LEDGER.md`: `128`
