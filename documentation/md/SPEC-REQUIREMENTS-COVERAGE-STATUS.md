...
1. Requirement files in `.agents/requirements/project/` and `.agents/requirements/software/`: `125`
2. Unique requirement IDs: `125`
3. IDs covered in `SPEC-REQUIREMENTS-TRACEABILITY-LEDGER.md`: `125`
