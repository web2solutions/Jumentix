...
1. Requirement files in `.agents/requirements/project/` and `.agents/requirements/software/`: `126`
2. Unique requirement IDs: `126`
3. IDs covered in `SPEC-REQUIREMENTS-TRACEABILITY-LEDGER.md`: `126`
