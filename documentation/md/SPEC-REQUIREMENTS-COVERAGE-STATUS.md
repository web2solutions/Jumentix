...
1. Requirement files in `.agents/requirements/project/` and `.agents/requirements/software/`: `136`
2. Unique requirement IDs: `136`
3. IDs covered in `SPEC-REQUIREMENTS-TRACEABILITY-LEDGER.md`: `136`
