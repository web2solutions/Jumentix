...
1. Requirement files in `.agents/requirements/project/` and `.agents/requirements/software/`: `132`
2. Unique requirement IDs: `132`
3. IDs covered in `SPEC-REQUIREMENTS-TRACEABILITY-LEDGER.md`: `132`
