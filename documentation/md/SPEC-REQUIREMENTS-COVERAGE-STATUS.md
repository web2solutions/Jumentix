...
1. Requirement files in `.agents/requirements/project/` and `.agents/requirements/software/`: `127`
2. Unique requirement IDs: `127`
3. IDs covered in `SPEC-REQUIREMENTS-TRACEABILITY-LEDGER.md`: `127`
