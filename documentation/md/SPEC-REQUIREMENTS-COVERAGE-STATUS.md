...
1. Requirement files in `.agents/requirements/project/` and `.agents/requirements/software/`: `133`
2. Unique requirement IDs: `133`
3. IDs covered in `SPEC-REQUIREMENTS-TRACEABILITY-LEDGER.md`: `133`
