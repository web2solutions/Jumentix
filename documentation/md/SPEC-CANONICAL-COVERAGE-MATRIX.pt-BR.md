...
| Rastreabilidade em nível de requisito | `.agents/requirements/*`, Issues, Projects, milestones e Project Updates do Linear | `SPEC-REQUIREMENTS-TRACEABILITY-LEDGER.md`, `SPEC-GOVERNANCE-AND-TRACEABILITY.md` | IDs de requisitos referenciados em PR |
