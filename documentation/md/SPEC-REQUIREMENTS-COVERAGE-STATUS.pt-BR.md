...
1. Arquivos de requisitos em `.agents/requirements/project/` e `.agents/requirements/software/`: `127`
2. IDs de requisitos exclusivos: `127`
3. IDs cobertos em `SPEC-REQUIREMENTS-TRACEABILITY-LEDGER.md`: `127`
