...
1. Arquivos de requisitos em `.agents/requirements/project/` e `.agents/requirements/software/`: `129`
2. IDs de requisitos exclusivos: `129`
3. IDs cobertos em `SPEC-REQUIREMENTS-TRACEABILITY-LEDGER.md`: `129`
