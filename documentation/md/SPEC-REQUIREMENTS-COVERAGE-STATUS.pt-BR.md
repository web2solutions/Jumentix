...
1. Arquivos de requisitos em `.agents/requirements/project/` e `.agents/requirements/software/`: `133`
2. IDs de requisitos exclusivos: `133`
3. IDs cobertos em `SPEC-REQUIREMENTS-TRACEABILITY-LEDGER.md`: `133`
