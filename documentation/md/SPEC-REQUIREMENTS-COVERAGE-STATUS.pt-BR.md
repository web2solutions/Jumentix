...
1. Arquivos de requisitos em `.agents/requirements/project/` e `.agents/requirements/software/`: `126`
2. IDs de requisitos exclusivos: `126`
3. IDs cobertos em `SPEC-REQUIREMENTS-TRACEABILITY-LEDGER.md`: `126`
