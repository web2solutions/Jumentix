...
1. Arquivos de requisitos em `.agents/requirements/project/` e `.agents/requirements/software/`: `135`
2. IDs de requisitos exclusivos: `135`
3. IDs cobertos em `SPEC-REQUIREMENTS-TRACEABILITY-LEDGER.md`: `135`
