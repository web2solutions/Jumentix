...
(deploy targets). **A JUM-545 foi entregue; a JUM-546 ainda está aberta** —
esta seção registra o ciclo de vida que o código realmente implementa hoje,
para que a lacuna restante seja legível em vez de descoberta clicando.
