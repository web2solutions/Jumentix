...
<!-- requirements-inventory: files=121 unique=118 mapped=118 duplicates=055,060,079 -->
...
- `009`, `018`, `019`, `023`, `024`, `025`, `033`, `035`, `056`, `057`, `064`, `066`, `067`, `068`, `071`, `072`, `073`, `075`, `076`, `077`, `078`, `079`, `080`, `081`, `082`, `083`, `084`, `085`, `086`, `087`, `088`, `089`, `090`, `094`, `095`, `097`, `098`, `099`, `100`, `101`, `102`, `103`, `104`, `105`, `106`, `107`, `108`, `109`, `110`, `111`, `112`, `113`, `114`, `116`, `117`
- Recursos de especificações:
...
1. Arquivos de requisitos no registro: `116`
2. IDs exclusivos no registro de requisitos: `118`
3. IDs exclusivos mapeados neste livro-razão: `118`
...
### `114`–`118` Pacote operacional de agentes (JUM-595)
- Specs: `documentation/md/AGENT-OPERATING-REQUIREMENTS-114-118.pt-BR.md` (+ EN)
- Requisitos: `.agents/requirements/114-*.md` … `118-*.md`
- Evidência: `bun run requirements:check`; paridade em `AGENTS.md` / `CLAUDE.md` / `GROK.md`; scripts Docker de smoke/integration para `118`
