...
O adapter Total.js conecta o runtime Total.js aos contratos HTTP do Jumentix. Ele fica na borda: recebe request, normaliza entrada, chama use cases e transforma o resultado em response.

## Tecnologia integrada

Framework Node.js full-stack com tooling integrado para web, API e aplicação.
...
Use quando: Aplicações que querem uma casca de framework mais ampla mantendo os use cases Jumentix isolados.

## Quando evitar

Evite para times padronizando runtimes menores apenas de HTTP.
