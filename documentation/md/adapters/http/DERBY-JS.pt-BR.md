...
O adapter Derby.js conecta o runtime Derby.js aos contratos HTTP do Jumentix. Ele fica na borda: recebe request, normaliza entrada, chama use cases e transforma o resultado em response.

## Tecnologia integrada

Framework MVC realtime full-stack para aplicações colaborativas.
...
Use quando: Superfícies colaborativas de produto que se beneficiam de convenções MVC realtime na borda.

## Quando evitar

Evite para APIs simples em que o modelo colaborativo vira sobrecarga desnecessária.
