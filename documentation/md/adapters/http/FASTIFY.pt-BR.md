...
O adapter Fastify conecta o runtime Fastify aos contratos HTTP do Jumentix. Ele fica na borda: recebe request, normaliza entrada, chama use cases e transforma o resultado em response.

## Tecnologia integrada

Framework HTTP de alta performance para Node.js com encapsulamento por plugins e requests orientados a schema.
...
Use quando: APIs com alto volume de requests, fronteiras fortes de validação e composição previsível por plugins.

## Quando evitar

Evite quando o time precisa de compatibilidade máxima com middlewares Express.
