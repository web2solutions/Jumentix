...
The Sails.js adapter connects the Sails.js runtime to Jumentix HTTP contracts. It stays at the edge: receive the request, normalize input, call use cases, and map the result back to a response.

## Integrated technology

MVC-oriented Node.js framework with batteries-included conventions.
...
Use it for: Convention-heavy server apps that need REST endpoints plus MVC-style structure.

## When to avoid

Avoid for small service boundaries where a lightweight adapter is easier to audit.
