...
O adapter LoopBack conecta o runtime LoopBack aos contratos HTTP do Jumentix. Ele fica na borda: recebe request, normaliza entrada, chama use cases e transforma o resultado em response.

## Tecnologia integrada

Framework de API com convenções fortes de model, controller e OpenAPI.
...
Use quando: APIs com muitos models que se beneficiam de controllers por convenção e metadados OpenAPI.

## Quando evitar

Evite quando o serviço deve manter a borda HTTP intencionalmente fina.
