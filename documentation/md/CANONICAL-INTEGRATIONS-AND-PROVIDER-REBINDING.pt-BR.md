...
| GitGuardian | O GitHub App está autorizado para os cinco repositórios XpertMinds; `Jumentix` está monitorado; o scan automático de histórico foi concluído; e checks bloqueantes de PR estão ativos | Observar resultado terminal de `GitGuardian Security Checks` na PR canônica |
