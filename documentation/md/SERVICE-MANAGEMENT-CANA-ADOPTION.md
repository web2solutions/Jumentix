...
- Multi-tab sync engine: [`apps/service-management/src/state/designerSync.js`](../../apps/service-management/src/state/designerSync.js); state core: [`apps/service-management/src/state/designerState.js`](../../apps/service-management/src/state/designerState.js); boot wiring and export/import glue: [`apps/service-management/script.js`](../../apps/service-management/script.js)
