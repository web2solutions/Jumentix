...
1. Requirement files in the registry: `121`
2. Unique requirement IDs in the registry: `118`
3. Unique IDs mapped in this ledger: `118`
...
### `114`–`118` Agent operating pack (JUM-595)
- Specs: `documentation/md/AGENT-OPERATING-REQUIREMENTS-114-118.md` (+ pt-BR)
- Requirements: `.agents/requirements/114-*.md` … `118-*.md`
- Evidence: `bun run requirements:check`; agent instruction parity in `AGENTS.md` / `CLAUDE.md` / `GROK.md`; Docker-backed smoke/integration scripts for `118`
