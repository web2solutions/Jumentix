...
Ferramentas privadas de bootstrap **não** são documentadas neste site público. Para o
primeiro backend, estude o app de referência do monorepo:

```bash
cd apps/backend-template
bun install
# siga os scripts do package.json / README desse app para subir localmente
```

Depois abra o [guia REST](/docs/pt-BR/jumentix/guides/rest-api) e reproduza o
caminho hello nesse template.
...
Antes de construir uma API completa, confirme que a toolchain de docs funciona.
Execute o playground abaixo — **Run** deve retornar verde e **Reset** deve
