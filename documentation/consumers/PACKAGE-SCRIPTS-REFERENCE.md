...
| `agent-registry:check` | Use when you need this specific workspace operation. | `pnpm run agent-registry:check` | `node ci-cd/check-agent-registry-source.js --check` |
| `agent-registry:sync` | Use when you need this specific workspace operation. | `pnpm run agent-registry:sync` | `node ci-cd/check-agent-registry-source.js --sync` |
| `agent-registry:url` | Use when you need this specific workspace operation. | `pnpm run agent-registry:url` | `node ci-cd/check-agent-registry-source.js --url` |
...
| `pr:governance:check` | Use when you need this specific workspace operation. | `pnpm run pr:governance:check` | `node ci-cd/check-pr-governance.js` |
...
| `ci:gate:branch` | Use in CI validation and delivery gates. | `pnpm run ci:gate:branch` | `node ci-cd/run-branch-quality-gate.js` |
| `ci:gate:task` | Use in CI validation and delivery gates. | `pnpm run ci:gate:task` | `node ci-cd/run-task-change-tests.js` |
...
| `website:storybook` | Operate the commercial website lifecycle. | `pnpm run website:storybook` | `pnpm --filter @jumentix/website storybook` |
| `website:storybook:build` | Operate the commercial website lifecycle. | `pnpm run website:storybook:build` | `pnpm --filter @jumentix/website storybook:build` |
| `website:storybook:smoke` | Operate the commercial website lifecycle. | `pnpm run website:storybook:smoke` | `pnpm --filter @jumentix/website storybook:smoke` |
