# Jumentix Consumer Documentation

This documentation is for **Jumentix consumers**: teams using Jumentix to build and run products.

It focuses on capabilities, integration paths, and how to launch software with Jumentix.
