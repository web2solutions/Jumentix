# Documentação para Criadores do Jumentix

Esta documentação é para **criadores/mantenedores do Jumentix**.

Ela inclui planejamento, migração, governança e referências internas de implementação que não são voltadas ao consumidor e não devem ser evidenciadas no site comercial.
