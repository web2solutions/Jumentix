# Jumentix Creator Documentation

This documentation is for **Jumentix creators/maintainers**.

It includes planning, migration, governance, and internal implementation references that are not consumer-facing and must not be highlighted on the commercial website.
