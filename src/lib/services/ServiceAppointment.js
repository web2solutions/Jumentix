...
/**
 * Class representing a ServiceAppointment Entity Service
 * @extends Service
 */
class ServiceAppointment extends Service {
  /**
   * Creates a ServiceAppointment Entity Service
   * @constructor
  ...
  constructor (application) {
    ...
    /**
        ...
        */
    this.entity = 'ServiceAppointment'
    /**
