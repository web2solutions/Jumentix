...
let job_task = new composer.message(
{
    ...
    "payload" :
    {
            ...
            "first_name": "fake data",
            "last_name": "fake data",
            "parent_1_first_name": "fake data",
            "parent_1_last_name": "fake data",
            "parent_2_first_name": "fake data",
            "parent_2_last_name": "fake data",
            "print_production_number": "fake data",
            "pf_user_name": "fake data",
            "phone": "fake data",
            "email": "fake data",
            "mailing_street": "fake data",
            "mailing_city": "fake data",
            "mailing_state": "fake data",
            "mailing_postalcode": "fake data",
            "mailing_country": "fake data",
            "access_token": "fake data"
    }
})
