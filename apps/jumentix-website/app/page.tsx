      ...
      <Stack gap="xl">
        <Stack gap="sm">
          ...
          <Group>
            ...
            <Button component={Link} href="/product" variant="light" size="md">
              Explore Product
            </Button>
          </Group>
        </Stack>
        ...
        <Card withBorder>
          ...
          <Group mt="md">
            <Button component={Link} href="/use-cases" variant="outline">
              View Use Cases
            </Button>
            <Button component={Link} href="/docs/jumentix" variant="subtle">
              Open Technical Docs
            </Button>
          </Group>
        </Card>
