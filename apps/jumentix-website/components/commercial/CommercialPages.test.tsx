...
describe('Commercial pages', () => {
  ...
  describe('Architecture page', () => {
    ...
    expect.hasAssertions();
      ...
      expect(screen.getByText('Browser in-memory playgrounds')).toBeInTheDocument();
      expect(screen.getByText('1. Read the boundary')).toBeInTheDocument();
      expect(screen.getByText('2. Run the smallest slice')).toBeInTheDocument();
      expect(screen.getByText('3. Compose domains')).toBeInTheDocument();
      expect(screen.getByText('4. Stress the system')).toBeInTheDocument();
      ...
      expect(screen.getByText('Browser MVP lab')).toBeInTheDocument();
      ...
      expect(screen.getByText(/Rejected requests are recoverable work/)).toBeInTheDocument();
      expect(screen.getByText('PM2 operations')).toBeInTheDocument();
    });
  });
