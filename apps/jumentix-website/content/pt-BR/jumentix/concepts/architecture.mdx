...
description: "DDD, Hexagonal, Event-Driven e estrutura do monorepo."
---
...
- Slot GUI inbound em `apps/backend-template/src/interface/GUI/` para futuros clientes web (SPA/PWA/React/Vue/…) e desktop (Electron/GTK/…) — só estrutura hoje; GUIs dirigem o núcleo e não devem possuir regras de domínio

Veja o mapa interativo no site comercial: [/pt-BR/architecture](/pt-BR/architecture).
