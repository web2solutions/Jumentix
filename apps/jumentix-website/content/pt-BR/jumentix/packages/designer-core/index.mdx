...
O núcleo do designer é a lógica separável que foi extraída do designer de Service Management (`apps/service-management`): tudo o
...
; a versão deste pacote não a repete.
