---
title: "Cana com React Context API"
description: "Do zero à implementação final: tarefas categorizadas com Cana e React Context."
---

> Source: `../../documentation/md/CANA-REACT-CONTEXT-TUTORIAL.pt-BR.md`
...
Compare com React Redux para apps maiores com slices e
selectors explícitos, ou Vue 3 + Pinia para o padrão de store Vue.
