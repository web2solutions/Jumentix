---
title: "Transações e eventos de mudança"
description: "Grave de forma atômica e atualize stores de UI a partir de eventos Cana commitados."
---

> Source: `../../documentation/md/CANA-USAGE-TRANSACTIONS-EVENTS.pt-BR.md`
...
Continue em [hooks e erros](/docs/pt-BR/jumentix/packages/cana/usage/hooks-errors).
