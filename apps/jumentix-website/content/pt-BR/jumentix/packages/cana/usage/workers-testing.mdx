---
title: "Workers e testes"
description: "Execute Cana através da fronteira de worker e planeje testes no browser."
---

> Source: `../../documentation/md/CANA-USAGE-WORKERS-TESTING.pt-BR.md`
...
Continue na [referência de API](/docs/pt-BR/jumentix/packages/cana/usage/api-reference).
