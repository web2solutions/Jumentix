...
description: "Guia de API do consumidor para @jumentix/cana com exemplos executáveis."
---

> Source: `../../documentation/md/CANA-USAGE-GUIDE.pt-BR.md`
...
workers, testes e resolução de problemas. Este guia é sobre usar `@jumentix/cana` na sua aplicação.
