---
title: "Cana com React Redux"
description: "Do zero à implementação final: tarefas categorizadas com Cana e Redux."
---

> Source: `../../documentation/md/CANA-REACT-REDUX-TUTORIAL.pt-BR.md`
...
Use React Context quando a superfície de estado for pequena.
Use Vue 3 + Pinia para construir o mesmo padrão offline em Vue.
