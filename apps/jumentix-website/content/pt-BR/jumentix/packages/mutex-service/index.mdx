...
description: "Locks nomeados sobre armazenamento chave/valor."
---

> Source: `../../packages/mutex-service/README.pt-BR.md`
...
Veja o [guia de uso](/docs/pt-BR/jumentix/packages/mutex-service/usage).
