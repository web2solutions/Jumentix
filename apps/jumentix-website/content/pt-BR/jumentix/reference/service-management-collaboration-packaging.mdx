...
- **O pacote é a casa canônica, não uma cópia.** Os módulos do núcleo
  ...
  sincronizada por
  `ci-cd/sync-service-management-designer-core.js`
...
(`{ kind: "service-management-suite", version: "2.0.0", domains, relationships, interfaces, serviceConfiguration, runtimeEnvironment, deployments, view }`) carregando **as quatro abas** em um formato
reimportável
