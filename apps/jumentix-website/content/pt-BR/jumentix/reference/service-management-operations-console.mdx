---
title: "Console de Operações do Service Management"
description: "A matriz de capacidades, o preview do ecossistema PM2 e o contrato de metadados dos alvos de deploy."
---
...
- **Os contratos de comunicação são referenciados, não duplicados.** A API de
  ...
  Requisito 126, Contratos 1 e 1b,
...
- **Persistência e comportamento de boot estão fora do escopo.** A porta de
  ...
  [Adoção do Cana no Service Management, migração e comportamento offline](/docs/pt-BR/jumentix/reference/service-management-cana-adoption).
...
- **Persistência e comportamento de boot** — a porta `IDesignerStore` e a
  ...
  pertencem ao
  [documento E3](/docs/pt-BR/jumentix/reference/service-management-module-architecture), e suas
  promessas ao usuário ao
  [documento E6](/docs/pt-BR/jumentix/reference/service-management-cana-adoption).
...
- Fontes de ecossistema: `pm2/ecosystem.dev.cjs`, `pm2/ecosystem.staging.cjs`, `pm2/ecosystem.production.cjs`
