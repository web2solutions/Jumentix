...
## 3.2) Export OAS por serviço e Swagger
...
RBAC (`TENANT-RBAC-AUTHORIZATION-CONTRACT.pt-BR.md`):
...
### 10.1) Contrato de exportação OAS 3.1
...
### 10.2) Ida e volta OAS sem perdas
