---
title: "Camada de dados offline do frontend"
description: "Boot Cana, repositório local, outbox, delta sync e shell PWA do apps/frontend."
---

# Camada de dados offline do frontend

The English version is at [FRONTEND-OFFLINE-DATA-LAYER.md](/docs/jumentix/reference/frontend-offline-data-layer).
