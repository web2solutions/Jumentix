...
- [README do aplicativo de gerenciamento de serviços](https://github.com/web2solutions/aaa-typescript-boilerplate/blob/dev/apps/service-management/README.md)
- [Pacotes do SDK do Workspace](/docs/jumentix/packages)
- [Matriz de capacidades da fábrica de serviços Jumentix](https://github.com/web2solutions/aaa-typescript-boilerplate/blob/dev/documentation/md/JUMENTIX-SERVICE-FACTORY-CAPABILITIES-MATRIX.md)
