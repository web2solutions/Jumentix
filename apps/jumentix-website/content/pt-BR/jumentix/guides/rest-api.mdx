...
- [Especificações OpenAPI](https://github.com/web2solutions/aaa-typescript-boilerplate/blob/dev/spec/1.0.0.yml)
- [Configurar tempo de execução e API](https://github.com/web2solutions/aaa-typescript-boilerplate/blob/dev/documentation/md/SETUP-RUNTIME-AND-API.md)
