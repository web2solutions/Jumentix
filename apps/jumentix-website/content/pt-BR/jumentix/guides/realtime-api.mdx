...
- [Contratos em tempo real WebSocket](https://github.com/web2solutions/aaa-typescript-boilerplate/blob/dev/documentation/md/contracts/WEBSOCKET-REALTIME-CONTRACTS.md)
- [Contratos em tempo real gRPC](https://github.com/web2solutions/aaa-typescript-boilerplate/blob/dev/documentation/md/contracts/GRPC-REALTIME-CONTRACTS.md)
