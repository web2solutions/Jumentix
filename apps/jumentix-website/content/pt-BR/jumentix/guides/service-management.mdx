...
![Entity Inspector: raiz de agregado, invariantes, matriz RBAC, contrato de mensagem, composição OpenAPI, campos e o preview de API CRUD gerado](/docs-assets/documentation/images/service-manager/03-entity-inspector.png "Entity Inspector")
...
![Painel Export com o preview de esqueleto de código e os exemplos de request e response gerados](/docs-assets/documentation/images/service-manager/05-export-panel.png "Painel Export")
