...
- [Arquitetura e Estrutura](https://github.com/XpertMinds/Jumentix/blob/dev/documentation/md/ARCHITECTURE-AND-STRUCTURE.md)
- [Hub de modelo de back-end](https://github.com/XpertMinds/Jumentix/blob/dev/apps/backend-template/documentation/README.md)
- [Implantar matriz de destino e empacotamento](https://github.com/XpertMinds/Jumentix/blob/dev/documentation/md/JUMENTIX-DEPLOY-TARGET-AND-PACKAGING-MATRIX.md)
