...
## 3.2) Per-service OAS export and Swagger
...
### 10.1) OAS 3.1 export contract

The OpenAPI 3.1 export produces a document compliant with the port-object
contract rules and the route-resolution check (`ci-cd/check-oas-route-resolution.js`):
