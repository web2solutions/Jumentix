...
| `tdd` | Use when you need this specific workspace operation. | `bun run tdd` | `NODE_ENV=dev bun x jest --watchAll` |
| `npm` | Use when you need this specific workspace operation. | `bun run npm` | `NODE_ENV=ci bun x jest ./apps/backend-template/test` |
| `test` | Run default backend-template test suite. | `bun run test` | `NODE_ENV=dev bun x jest ./apps/backend-template/test` |
