---
title: "Creating Realtime API with Jumentix"
description: "Guide for WebSocket/gRPC realtime APIs."
---
...
- [Realtime WebSocket API](https://github.com/web2solutions/aaa-typescript-boilerplate/blob/dev/documentation/md/adapters/realtime/WEBSOCKET-API.md)
- [Realtime gRPC API](https://github.com/web2solutions/aaa-typescript-boilerplate/blob/dev/documentation/md/adapters/realtime/GRPC-API.md)
- [WebSocket Realtime Contracts](https://github.com/web2solutions/aaa-typescript-boilerplate/blob/dev/documentation/md/contracts/WEBSOCKET-REALTIME-CONTRACTS.md)
- [gRPC Realtime Contracts](https://github.com/web2solutions/aaa-typescript-boilerplate/blob/dev/documentation/md/contracts/GRPC-REALTIME-CONTRACTS.md)
