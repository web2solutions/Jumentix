---
title: "Creating SPA/PWA with Jumentix"
description: "Guide for frontend SPA/PWA delivery."
---
...
- [Service Management App README](https://github.com/web2solutions/aaa-typescript-boilerplate/blob/dev/apps/service-management/README.md)
- [Workspace SDK Packages](https://github.com/web2solutions/aaa-typescript-boilerplate/blob/dev/packages/README.md)
- [Jumentix Service Factory Capabilities Matrix](https://github.com/web2solutions/aaa-typescript-boilerplate/blob/dev/documentation/md/JUMENTIX-SERVICE-FACTORY-CAPABILITIES-MATRIX.md)
