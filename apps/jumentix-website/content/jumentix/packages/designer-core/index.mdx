...
The designer core is the separable logic carved out of the Service Management designer (`apps/service-management`):
...
; this package's version does not restate it.
