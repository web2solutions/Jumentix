...
> Source: `../../packages/designer-core/README.md`
...
Per
[Requirement 070](https://github.com/XpertMinds/Jumentix/blob/dev/.agents/requirements/project/070-xpertminds-npm-and-web2solutions-vercel-integration.md),
...
MIT — see [LICENSE.md](https://github.com/XpertMinds/Jumentix/blob/dev/packages/designer-core/LICENSE.md).
