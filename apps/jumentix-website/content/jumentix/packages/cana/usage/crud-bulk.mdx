---
title: "Reading, writing and bulk operations"
description: "Use CRUD and bulk operations with complete task examples."
---

> Source: `../../documentation/md/CANA-USAGE-CRUD-BULK.md`
...
Continue to [querying and plans](/docs/jumentix/packages/cana/usage/querying).
