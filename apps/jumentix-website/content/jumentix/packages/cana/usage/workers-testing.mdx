---
title: "Workers and testing"
description: "Run Cana through a worker boundary and plan browser tests."
---

> Source: `../../documentation/md/CANA-USAGE-WORKERS-TESTING.md`
...
Continue to the [API reference](/docs/jumentix/packages/cana/usage/api-reference).
