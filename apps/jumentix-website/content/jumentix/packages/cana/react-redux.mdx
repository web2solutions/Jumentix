---
title: "Cana with React Redux"
description: "From zero to final implementation: categorized tasks with Cana and Redux."
---

> Source: `../../documentation/md/CANA-REACT-REDUX-TUTORIAL.md`
...
Use React Context when the state surface is small. Use
Vue 3 + Pinia when building the same offline pattern in Vue.
