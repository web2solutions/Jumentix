---
title: "Cana with React Context API"
description: "From zero to final implementation: categorized tasks with Cana and React Context."
---

> Source: `../../documentation/md/CANA-REACT-CONTEXT-TUTORIAL.md`
...
Compare this with React Redux for larger apps with explicit
slices and selectors, or Vue 3 + Pinia for the Vue store pattern.
