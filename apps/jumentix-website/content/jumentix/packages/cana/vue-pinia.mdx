---
title: "Cana with Vue 3 and Pinia"
description: "From zero to final implementation: categorized tasks with Cana, Vue 3 and Pinia."
---

> Source: `../../documentation/md/CANA-VUE-PINIA-TUTORIAL.md`
...
Compare the same model in React Context and
React Redux.
