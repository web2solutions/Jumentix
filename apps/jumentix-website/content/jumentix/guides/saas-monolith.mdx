...
- [Architecture and Structure](https://github.com/web2solutions/aaa-typescript-boilerplate/blob/dev/documentation/md/ARCHITECTURE-AND-STRUCTURE.md)
- [Backend Template Hub](https://github.com/web2solutions/aaa-typescript-boilerplate/blob/dev/apps/backend-template/documentation/README.md)
- [Deploy Target and Packaging Matrix](https://github.com/web2solutions/aaa-typescript-boilerplate/blob/dev/documentation/md/JUMENTIX-DEPLOY-TARGET-AND-PACKAGING-MATRIX.md)
