...
![Entity Inspector: aggregate root, invariants, the RBAC matrix, a message contract, OpenAPI composition, fields and the generated CRUD API preview](/docs-assets/documentation/images/service-manager/03-entity-inspector.png "Entity Inspector")
...
![Export panel with the code skeleton preview and the generated request and response examples](/docs-assets/documentation/images/service-manager/05-export-panel.png "Export panel")
