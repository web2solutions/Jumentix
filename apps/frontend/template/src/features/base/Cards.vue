...
interface CardColorExample {
  color: string
  textColor?: string
}

const backgroundColorExamples: CardColorExample[] = [
...
const borderColorExamples: CardColorExample[] = [
      ...
      <CCard class="mb-4">
        ...
        <CCardBody>
          ...
          <DocsExample href="components/card.html/#background-and-color">
            <CRow>
              <template v-for="item in backgroundColorExamples" :key="item.color">
                <CCol :lg="4">
                  <CCard
                    class="mb-3"
                    :color="item.color"
          ...
          <DocsExample href="components/card.html/#border">
            <template
              v-for="item in borderColorExamples"
              :key="item.color"
            >
              <CCard
                :text-color="item.textColor"
