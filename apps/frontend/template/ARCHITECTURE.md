# UI Application Template - Architecture

This document provides a comprehensive overview of the UI Application Template architecture, design patterns, and technical implementation details.
...
| ESLint | 9.39.4 | TypeScript linting and code quality |
...
│       └── _nav.ts                  # Sidebar navigation configuration
│
...
**Responsibility**: Provides consistent layout structure for authenticated features.
...
- Integrates with _nav.ts for menu structure
    ...
    children: [
      {
        path: '404',
        name: 'Page404',
        component: () => import('@/features/pages/Page404'),
      },
    ],
  },
]
...
Navigation structure defined in `_nav.ts`:
