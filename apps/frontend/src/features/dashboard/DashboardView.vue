...
interface ProgressComparisonExample {
  title: string
  value1: number
  value2: number
}

interface ProgressIconExample {
  title: string
  icon: string
  value: number
}

interface TrafficSourceExample {
  title: string
  icon: string
  percent: number
  value: string
...
interface TableExample {
  ...
  usage: { value: number; period: string; color: string }
  payment: { name: string; icon: string }
  activity: string
}

const progressGroupExample1: ProgressComparisonExample[] = [
...
const progressGroupExample2: ProgressIconExample[] = [
  { title: 'Male', icon: 'cil-user', value: 53 },
  { title: 'Female', icon: 'cil-user-female', value: 43 },
]
const progressGroupExample3: TrafficSourceExample[] = [
  { title: 'Organic Search', icon: 'cib-google', percent: 56, value: '191,235' },
...
// Text avatars instead of the template's binary avatar images.
const tableExample: TableExample[] = [
  {
    initials: 'YA',
    status: 'success',
          ...
          <CCardBody>
            <CRow>
              ...
              <CCol :sm="7" class="d-none d-md-block">
                ...
                <CButtonGroup class="float-end me-3" role="group" aria-label="Traffic range">
              ...
              <CTableBody>
                <CTableRow v-for="item in tableExample" :key="item.user.name">
                  <CTableDataCell class="text-center">
                    <CAvatar size="md" :status="item.status" color="secondary" text-color="white">
                      {{ item.initials }}
                    </CAvatar>
                  </CTableDataCell>
                  <CTableDataCell>
