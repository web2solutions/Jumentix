...
const widgetChartRef1 = ref<ChartComponentRef>()
const widgetChartRef2 = ref<ChartComponentRef>()

const syncWidgetChartColors = () => {
...
onMounted(() => {
  document.documentElement.addEventListener('ColorSchemeChange', syncWidgetChartColors)
})

onUnmounted(() => {
  document.documentElement.removeEventListener('ColorSchemeChange', syncWidgetChartColors)
})
...
const barLabels = [...months, 'August', 'September', 'October', 'November', 'December', 'January', 'February', 'March', 'April']

const widgetActionItems = ['Action', 'Another action', 'Something else here']
</script>
      ...
      <CWidgetStatsA color="primary">
        ...
        <template #action>
          <CDropdown placement="bottom-end">
            ...
            <CDropdownMenu>
              <CDropdownItem v-for="item in widgetActionItems" :key="item" href="#">
                {{ item }}
              </CDropdownItem>
            </CDropdownMenu>
          </CDropdown>
