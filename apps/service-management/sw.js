...
const SHELL_ASSETS = [
  ...
  // vendored into the app by apps/service-management/scripts/sync-service-management-designer-core.js
  ...
  './vendor/designer-core/model/architecture.js',
  ...
  './vendor/designer-core/validation/architectureValidation.js',
  ...
  './src/ui/architectureCanvas.js',
  './src/ui/canvas.js',
  './src/ui/canvasImage.js',
  './src/ui/controlHelp.js',
  ...
  // apps/service-management/scripts/sync-service-management-cana-bundle.js, which the browser smoke
  ...
  // Vendored D3 (JUM-767): monitoringCharts imports bare `d3` via the import
  // map. GENERATED by apps/service-management/scripts/sync-service-management-d3.js (gitignored).
  './vendor/d3/index.js',
