...
[![Cheiros de código](https://sonarcloud.io/api/project_badges/measure?project=XpertMinds_Jumentix&metric=code_smells)](https://sonarcloud.io/summary/new_code?id=XpertMinds_Jumentix)
[![Bugs](https://sonarcloud.io/api/project_badges/measure?project=XpertMinds_Jumentix&metric=bugs)](https://sonarcloud.io/summary/new_code?id=XpertMinds_Jumentix)
[![Vulnerabilidades](https://sonarcloud.io/api/project_badges/measure?project=XpertMinds_Jumentix&metric=vulnerabilities)](https://sonarcloud.io/summary/new_code?id=XpertMinds_Jumentix)
