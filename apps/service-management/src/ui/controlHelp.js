...
const SPECIFIC_HELP = {
  'tab-architecture-btn': ['Architecture', 'Draw services, assign domains and communication links. One Core service hosts Users.'],
  ...
  'tab-openapi-btn': ['OpenAPI', 'Render the generated OAS in Swagger UI and pick a service address.'],
  'architecture-service-name-input': ['New Service Name', 'Names a domain service that will host assigned bounded contexts.'],
  'architecture-add-service-btn': ['Add Service', 'Creates a domain service box on the architecture canvas.'],
  'architecture-inspect-name': ['Service Name', 'Renames the selected service.'],
  'architecture-inspect-kind': ['Service Kind', 'Marks the service as Core (exactly one) or domain.'],
  'architecture-inspect-url': ['Service URL', 'Public address written to OAS servers and x-services.'],
  'architecture-inspect-deploy': ['Deploy Target', 'Optional deploy-target id linked to this service.'],
  'architecture-inspect-domain': ['Domain To Move', 'Keyboard alternative to dragging a domain onto the selected service.'],
  'architecture-move-domain-btn': ['Move Domain Here', 'Assigns the chosen domain to the selected service.'],
  'architecture-save-service-btn': ['Save Service', 'Persists inspector edits for the selected service.'],
  'architecture-delete-service-btn': ['Delete Service', 'Removes the service and returns its domains to Core.'],
  'architecture-link-from': ['Link Source', 'Service that originates the communication link.'],
  'architecture-link-to': ['Link Target', 'Service that receives the communication link.'],
  'architecture-link-protocol': ['Link Protocol', 'rest, grpc, websocket or message.'],
  'architecture-add-link-btn': ['Add Link', 'Draws a protocol link between two services.'],
  'architecture-export-image-btn': ['Export Architecture Image', 'Downloads a PNG of the architecture service list.'],
  'openapi-service-select': ['OpenAPI Service', 'Shows the merged Core document or a per-service filtered OAS.'],
  'openapi-refresh-btn': ['Refresh OpenAPI', 'Rebuilds Swagger UI from the current designer model.'],
